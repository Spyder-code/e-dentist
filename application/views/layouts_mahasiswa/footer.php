...
<br>
  ...
  <script src="<?php echo base_url().'assets/chartjs/mahasiswa/bulanan.js'?>"></script>
       ...
       $('#kode').on('input',function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        $.each(data,function(kode, deskripsi){
  ...
  <script type="text/javascript">
    $(document).ready(function(){
       $('#kodee').on('input',function(){
                
                var kodee=$(this).val();
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('mahasiswa/get_diagnosa')?>",
                    dataType : "JSON",
                    data : {kodee: kodee},
                    cache:false,
                    success: function(data){
                        $.each(data,function(kodee, nama){
  ...
  var data_bln = [];
    ...
    $.post("<?= base_url('mahasiswa/getData') ?>",
      function(data){
