...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'mahasiswa/pasien'?>">
        <i class="fas fa-user-injured"></i>
          <span>Data Pasien</span></a>
           <hr class="sidebar-divider">
         <a class="nav-link" href="<?php echo base_url().'mahasiswa/laporan'?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo base_url('assets/profile/mahasiswa/'.$this->session->userdata('ses_gambar')); ?>">
              </a>
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?php echo base_url('mahasiswa/show_profile'); ?>">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Profile
                </a>
                <a class="dropdown-item" href="<?php echo base_url('mahasiswa/ubah_password'); ?>" >
