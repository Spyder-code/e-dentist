...
<br>
  ...
  <script src="<?php echo base_url().'assets/chartjs/dosen/mahasiswa.js'?>"></script>
  <script src="<?php echo base_url().'assets/chartjs/dosen/bulanan.js'?>"></script>

<script>
  var data_mhs = [];
    var data_jmlh= [];

    $.post("<?= base_url('dosen/getDataMhs') ?>",
      function(data){
        var obj = JSON.parse(data);
        $.each(obj, function (test,item){
          data_mhs.push(item.nama);
