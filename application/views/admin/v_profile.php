          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                 <h5 class="left m-0 font-weight- text-primary"><center>Edit Profile Admin</h5> </center>  
              </div>
              <br>
             
              <form class="user" action="<?php echo site_url('admin/update_profile');?>" method="post" enctype="multipart/form-data">
