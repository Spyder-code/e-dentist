        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="<?php echo site_url('admin/update_mahasiswa_d4');?>" method="post">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="tempat" class="fform-control form-control-user"  placeholder="Tempat Lahir"  value="<?php echo $tempat;?>">
                  </div>
