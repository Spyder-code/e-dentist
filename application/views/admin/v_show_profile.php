<?php 
  ...
  <!-- Begin Page Content -->
         <div class="container-fluid">
          ...
          <div class="card shadow mb-4"class="rounded" style="max-width: 1000px;height:570px;top: 70px;position: relative;display: block;margin: auto;">

            <?php foreach($show_profile as $prf){
                     ?>

            <form class="user" action="<?=  base_url('admin/profile'); ?>"method="post">
            <div class="row no-gutters">
              <div class="container">
               <img   src="<?=base_url()?>assets/profile/dosen/<?=$prf->gambar?>" class="card shadow mb-9 img-responsive img-thumbnail img-circle "alt="..."style="width:250px;height:250px;border-radius: 100% ;border: 4px solid   #4e73df;display: block;margin: auto;position: relative; bottom: 60px">
              ...
              <div style="text-align:justify;"><font color=" #4e73df"><h1 class="card-title"><center><strong><?php echo $prf->nama;?></strong> </center>  </h1></font>
                <div class="containerr">
                    ...
                    <table align="center" cellpadding="10" border="0">
                       <tr>
                          <td style="color:#4e73df;" >NIP</td>
                          <td style="color:#4e73df;">:</td>
                          <td style="color:#4e73df;"><?php echo $prf->nip;?></td>
                        </tr>
                        <tr>
